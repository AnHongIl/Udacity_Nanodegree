...
class DDPGAgent():
    def __init__(self, state_size, action_size, random_seed, hidden_units, lr_actor, lr_critic, batch_size, gamma, memory_size, num_actors, epsilon, tau):
        ...
        self.noise = OUNoise(action_size, self.seed, self.num_actors)
